  ...
  groupList.forEach((group, index) => {
    ...
    likeButton.addEventListener('click', async() => {
      ...
      if(response.success == true) {
        ...
        if(response.state == )
        const likeBtnText = (group.likes?.includes(email)) ? likeBtnSvg2 : likeBtnSvg1;

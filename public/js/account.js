const notificationAlertSuccess = document.getElementById(
  "notification-alert-success"
);
const notificationAlertFail = document.getElementById(
...
const closeBtnFront = document.querySelector(
  "#accountModal .card-front .closeBtn"
);
const closeBtnBack = document.querySelector(
  "#accountModal .card-back .closeBtn"
);
...
function oauthSignIn() {
  ...
  const timezone = getUserTimezone();
  const redirect_uri = window.location.origin + "/auth/signin/google";
  const scope = "email profile";
  const client_id =
    "569997433857-a5jdjf2k8oa46dopid8tt7s1lbcv8129.apps.googleusercontent.com";

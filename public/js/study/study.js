      ...
      group.members.forEach(member => {
        ...
        <div class="member">
          ...
          <div class="member-time">
            <div id="digits">
              <span class="m-hr-${member.userId}"></span>
              <span class="m-min-${member.userId}"></span>
              <span class="m-sec-${member.userId}"></span>
            </div>
          </div>
        </div>
        ...
        member.timer.secDisp = document.querySelector('.m-sec-' + member.userId);
        member.timer.minDisp = document.querySelector('.m-min-' + member.userId);
        member.timer.hrDisp = document.querySelector('.m-hr-' + member.userId);

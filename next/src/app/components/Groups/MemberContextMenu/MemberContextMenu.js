      ...
      fetch(`${config.server}/groups/transfer-ownership`, {
        ...
        .then((data) => {
          ...
          if (data.success) {
            setResponse({
              success: true,
              msg: `Transfered Ownership to ${memberName}`,
            });
          } else {
            setResponse(data);
          }
  ...
  return (
    <StyleWrapper>
      <Menu id={MENU_ID}>
        ...
        <Item id="deafen" onClick={handleItemClick}>
          Deafen {memberName}
        </Item>
        ...
        {kickClicked ? (
          <Item id="confirmKick" type="danger" onClick={handleItemClick}>
            Kick?
          </Item>
        ) : (
          <Item
        ...
        {transferClicked ? (
          <Item id="confirmTransfer" type="danger" onClick={handleItemClick}>
            Transfer?
          </Item>
        ) : (
          <Item

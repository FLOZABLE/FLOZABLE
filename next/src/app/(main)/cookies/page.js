  ...
  return (
    <main className={styles.Cookies}>
      ...
      <div className="layer">
        ...
        <h3 className="subHeading">What are cookies?</h3>
        <div className="description">
          <p>
      ...
      <div className="layer">
        <div className="description">
          <h3 className="subHeading">How can I control cookies?</h3>
          <p>
        ...
        <h3 className="subHeading">The specific types of cookies we use</h3>
        <div className="description">
          <p>
          ...
          <h4 className="subSubHeading">Unclassified cookies:</h4>
          <p>
          ...
          <div className={styles.cookie}>
            ...
            <div className={styles.right}>
              ...
              <p>flozable.com</p>
              <p>Service worker functionality</p>
              <p>United States</p>
              <p>server_cookie</p>
              <p>session</p>
            </div>
          ...
          {/* <table>
            ...
            <tbody>
              <tr>
                ...
                <td>flozable.com</td>
                <td>Service worker functionality</td>
                <td>United States</td>
                <td>server_cookie</td>
                <td>session</td>
              </tr>
              <tr>
                <td>serviceWorkerRegistered</td>
                <td>__________</td>
                <td>flozable.com</td>
                <td>__________</td>
                <td>United States</td>
        ...
        <h3 className="subHeading">How can I control cookies on my browser?</h3>
        <div className="description">
          <p>
          ...
          <ul>
            ...
            <li>
              <a
                href="https://www.youradchoices.ca/en/tools"
                target="_blank"
                rel="noopener noreferrer"
              >
      ...
      <div className="layer">
        ...
        <h3 className="subHeading">Do you serve targeted advertising?</h3>
        <div className="description">
          <p>
        ...
        <h3 className="subHeading">Where can I get further information?</h3>
        <div className="description">
          <p>

...
export default function Terms() {
  return (
    <main className={styles.Terms}>
      ...
      <div className="layer" id="toc">
        ...
        <div className="description">
          <ol>
            ...
            <li>
              <Link href="#ip">INTELLECTUAL PROPERTY RIGHTS</Link>
            </li>
            <li>
              <Link href="#userrep">USER REPRESENTATIONS</Link>
            </li>
            <li>
              <Link href="#registration">USER REGISTRATION</Link>
            </li>
            <li>
              <Link href="#prohibited">PROHIBITED ACTIVITIES</Link>
            </li>
            <li>
              <Link href="#ugc">USER GENERATED CONTRIBUTIONS</Link>
            </li>
            <li>
              <Link href="#license">CONTRIBUTION LICENSE</Link>
            </li>
            <li>
              <Link href="#reviews">GUIDELINES FOR REVIEWS</Link>
            </li>
            <li>
              <Link href="#mobile">MOBILE APPLICATION LICENSE</Link>
            </li>
            <li>
              <Link href="#socialmedia">SOCIAL MEDIA</Link>
            </li>
            <li>
              <Link href="#management">SERVICES MANAGEMENT</Link>
            </li>
            <li>
              <Link href="#privacy">PRIVACY POLICY</Link>
            </li>
            <li>
              <Link href="#term">TERM AND TERMINATION</Link>
            </li>
            <li>
              <Link href="#modifications">MODIFICATIONS AND INTERRUPTIONS</Link>
            </li>
            <li>
            ...
            <li>
              <Link href="#liability">LIMITATIONS OF LIABILITY</Link>
            </li>
            <li>
            ...
            <li>
              <Link href="#california">CALIFORNIA USERS AND RESIDENTS</Link>
            </li>
            <li>
      ...
      <div className="layer" id="services">
      ...
      <div className="layer" id="ip">
        <h2 className="heading">2. INTELLECTUAL PROPERTY RIGHTS</h2>
        <h3 className="subHeading">Our intellectual property</h3>
        <div className="description">
          <p>
        ...
        <h3 className="subHeading">Your use of our Services</h3>
        <div className="description">
          <p>
          ...
          <p>
            ...
            please address your request to: contact@flozable.com. If we ever
      ...
      <div className="layer" id="userrep">
        <h2 className="heading">3. USER REPRESENTATIONS</h2>
        <div className="description">
          <p>
      ...
      <div className="layer" id="registration">
        <h2 className="heading">4. USER REGISTRATION</h2>
        <div className="description">
          <p>
      ...
      <div className="layer" id="prohibited">
        <h2 className="heading">5. PROHIBITED ACTIVITIES</h2>
        <div className="description">
          <p>
      ...
      <div className="layer" id="ugc">
        <h2 className="heading">6. USER GENERATED CONTRIBUTIONS</h2>
      ...
      <div className="layer" id="license">
        <h2 className="heading">7. CONTRIBUTION LICENSE</h2>
        <div className="description">
          <p>
      ...
      <div className="layer" id="reviews">
        <h2 className="heading">8. GUIDELINES FOR REVIEWS</h2>
        <div className="description">
          <p>
      ...
      <div className="layer" id="mobile">
        <h2 className="heading">9. MOBILE APPLICATION LICENSE</h2>
        <div className="description">
          <h3>Use License</h3>
          <p>
      ...
      <div className="layer" id="socialmedia">
        <h2 className="heading">10. SOCIAL MEDIA</h2>
        <div className="description">
          <p>
      ...
      <div className="layer" id="management">
        <h2 className="heading">11. SERVICES MANAGEMENT</h2>
        <div className="description">
          <p>
      ...
      <div className="layer" id="privacy">
        <h2 className="heading">12. PRIVACY POLICY</h2>
        <div className="description">
          <p>
            We care about data privacy and security. Please review our{" "}
            <Link href="/privacy">Privacy Policy</Link>. By using the Services,
      ...
      <div className="layer" id="modifications">
        <h2 className="heading">14. MODIFICATIONS AND INTERRUPTIONS</h2>
        <div className="description">
          <p>
      ...
      <div className="layer" id="disputes">
        <h2 className="heading">16. Dispute Resolution</h2>
        <div className="description">
      ...
      <div className="layer" id="corrections">
        <h2 className="heading">17. Corrections</h2>
        <div className="description">
          <p>
      ...
      <div className="layer" id="disclaimer">
      ...
      <div className="layer" id="liability">
        <h2 className="heading">19. LIMITATIONS OF LIABILITY</h2>
        <div className="description">
          <p>
            ...
            ARISING OR . CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT
      ...
      <div className="layer" id="indemnification">
        <h2 className="heading">20. INDEMNIFICATION</h2>
        <div className="description">
          <p>
      ...
      <div className="layer" id="userdata">
        <h2 className="heading">21. USER DATA</h2>
        <div className="description">
          <p>
      ...
      <div className="layer" id="electronic">
      ...
      <div className="layer" id="california">
        <h2 className="heading">23. CALIFORNIA USERS AND RESIDENTS</h2>
        <div className="description">
          <p>
      ...
      <div className="layer" id="misc">
        <h2 className="heading">24. MISCELLANEOUS</h2>
        <div className="description">
          <p>

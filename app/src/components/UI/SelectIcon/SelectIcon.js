...
function SelectIcon(props) {
  const { selectedIcon, setSelectedIcon, isSelectIcon, setIsSelectIcon, setIsSelectColor } = props;
  ...
  return (
    <div className={styles.selectIcon}>
      <div className={styles.header}>
        <button onClick={() => { setIsSelectIcon(!isSelectIcon); setIsSelectColor(false) }}>
          {!selectedIcon.el ? <p>Select Subject's Icon!</p> : <p>Selected Icon: </p>}
        </button>
